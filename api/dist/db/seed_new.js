...
async function seed() {
    ...
    try {
        ...
        const plant1 = await prisma_1.prisma.plant.upsert({
            where: { idPlant: 1 },
            update: {},
            create: { idPlant: 1, designationPlant: "FMS-Alpha" },
        });
        const plant2 = await prisma_1.prisma.plant.upsert({
            where: { idPlant: 2 },
            update: {},
            create: { idPlant: 2, designationPlant: "FMS-Beta" },
        });
        const plant3 = await prisma_1.prisma.plant.upsert({
            where: { idPlant: 3 },
            update: {},
            create: { idPlant: 3, designationPlant: "A&D-Gamma" },
        });
        console.log(`✅ Created/Updated plants: ${plant1.designationPlant}, ${plant2.designationPlant}, ${plant3.designationPlant}\n`);
        // 2. Create Users (aspnet_Users)
        console.log("👤 Creating users...");
        const adminId = (0, crypto_1.randomUUID)();
        const auditor1Id = (0, crypto_1.randomUUID)();
        const auditor2Id = (0, crypto_1.randomUUID)();
        const supervisorId = (0, crypto_1.randomUUID)();
        ...
        const audit1 = await prisma_1.prisma.audits.upsert({
            where: { id: 1 },
            update: {},
            create: {
                id: 1,
        ...
        const audit2 = await prisma_1.prisma.audits.upsert({
            where: { id: 2 },
            update: {},
            create: {
                id: 2,
        ...
        const audit3 = await prisma_1.prisma.audits.upsert({
            where: { id: 3 },
            update: {},
            create: {
                id: 3,
        ...
        console.log(`✅ Created/Updated audits: ${audit1.auditTypeName}, ${audit2.auditTypeName}, ${audit3.auditTypeName}\n`);
        // 4. Create Audit Details
        console.log("📝 Creating audit details...");
        const details = [];
        // Details for Audit 1
        for (let i = 1; i <= 5; i++) {
            const detail = await prisma_1.prisma.audit_details.upsert({
                where: { id: (i - 1) * 10 + 1 },
                update: {},
                create: {
                    id: (i - 1) * 10 + 1,
        ...
        const statusOpen = await prisma_1.prisma.setts_action_status.upsert({
            where: { id_status: 1 },
            update: {},
            create: { id_status: 1, etat_status: "Open" },
        });
        const statusInProgress = await prisma_1.prisma.setts_action_status.upsert({
            where: { id_status: 2 },
            update: {},
            create: { id_status: 2, etat_status: "In Progress" },
        });
        const statusClosed = await prisma_1.prisma.setts_action_status.upsert({
            where: { id_status: 3 },
            update: {},
            create: { id_status: 3, etat_status: "Closed" },
        });
        console.log(`✅ Created/Updated action statuses: ${statusOpen.etat_status}, ${statusInProgress.etat_status}, ${statusClosed.etat_status}\n`);
        // 6. Create Actions
        console.log("✅ Creating actions...");
        const actions = [];
        for (let i = 1; i <= 3; i++) {
            const action = await prisma_1.prisma.actions.upsert({
                where: { id: i },
                update: {},
                create: {
                    id: i,
        ...
        const schedule1 = await prisma_1.prisma.schedules.upsert({
            where: { id: 1 },
            update: {},
            create: {
                id: 1,
        ...
        const schedule2 = await prisma_1.prisma.schedules.upsert({
            where: { id: 2 },
            update: {},
            create: {
                id: 2,
        ...
        const schedule3 = await prisma_1.prisma.schedules.upsert({
            where: { id: 3 },
            update: {},
            create: {
                id: 3,
        ...
        console.log(`✅ Created/Updated schedules: ${schedule1.scheduleName}, ${schedule2.scheduleName}, ${schedule3.scheduleName}\n`);
        // 8. Create Audit Types
        console.log("🏷️  Creating audit types...");
        const auditType1 = await prisma_1.prisma.setts_audit_types.upsert({
            where: { id: 1 },
            update: {},
            create: { id: 1, audit_type: "SAFETY", name: "Safety Audit" },
        });
        const auditType2 = await prisma_1.prisma.setts_audit_types.upsert({
            where: { id: 2 },
            update: {},
            create: { id: 2, audit_type: "MAINTENANCE", name: "Maintenance Audit" },
        });
        const auditType3 = await prisma_1.prisma.setts_audit_types.upsert({
            where: { id: 3 },
            update: {},
            create: { id: 3, audit_type: "COMPLIANCE", name: "Compliance Audit" },
        });
        console.log(`✅ Created/Updated audit types: ${auditType1.name}, ${auditType2.name}, ${auditType3.name}\n`);
        // 9. Create Question Groups
        console.log("❓ Creating audit question groups...");
        const group1 = await prisma_1.prisma.setts_audit_question_groups.upsert({
            where: { id: 1 },
            update: {},
            create: {
                id: 1,
        ...
        const group2 = await prisma_1.prisma.setts_audit_question_groups.upsert({
            where: { id: 2 },
            update: {},
            create: {
                id: 2,
        ...
        console.log(`✅ Created/Updated audit question groups: ${group1.group_name}, ${group2.group_name}\n`);
        // Summary
        console.log("\n" + "=".repeat(60));
